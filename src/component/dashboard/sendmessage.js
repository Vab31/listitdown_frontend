...
export default function Sendmessage() {
  ...
  <div className="container px-5 py-24 mx-auto text-gray-600  flex flex-wrap items-center">
    <div className="lg:w-3/5 md:w-1/2 md:pr-16  lg:pr-0 pr-0">
        <img className='rounded-full boder-4  shadow-2xl border-black ' src={img} alt='login page'/>
        </div>
    <div className="lg:w-2/6 md:w-1/2 border-black-500 boder-4 shadow-2xl bg-blue-400 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
